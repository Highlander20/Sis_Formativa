<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('curso') }}
            {{ Form::select('curso_id', $cursos, $docente->curso_id, ['class' => 'form-control' . ($errors->has('curso_id') ? ' is-invalid' : ''), 'placeholder' => 'Curso Id']) }}
            {!! $errors->first('curso_id', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('nombre') }}
            {{ Form::text('nombre_doc', $docente->nombre_doc, ['class' => 'form-control' . ($errors->has('nombre_doc') ? ' is-invalid' : ''), 'placeholder' => 'Nombre Doc']) }}
            {!! $errors->first('nombre_doc', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('apellido') }}
        ...
        <div class="form-group">
            {{ Form::label('grado') }}
            {{ Form::text('grado', $docente->grado, ['class' => 'form-control' . ($errors->has('grado') ? ' is-invalid' : ''), 'placeholder' => 'Grado']) }}
            {!! $errors->first('grado', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('profesion') }}
            {{ Form::text('profesion', $docente->profesion, ['class' => 'form-control' . ($errors->has('profesion') ? ' is-invalid' : ''), 'placeholder' => 'Profesion']) }}
        ...
        <div class="form-group">
            {{ Form::label('dni') }}
            {{ Form::text('dni', $docente->dni, ['class' => 'form-control' . ($errors->has('dni') ? ' is-invalid' : ''), 'placeholder' => 'Dni']) }}
